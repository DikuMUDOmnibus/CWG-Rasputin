...
void cedit_disp_menu(struct descriptor_data *d)
{
  ...
  write_to_output(d, 
  	  ...
  	  "@gG@n) Game Play Options\r\n"
  	  "@gC@n) Crashsave/Rent Options\r\n"
  	  "@gR@n) Room Numbers\r\n"
          "@gO@n) Operation Options\r\n"
          "@gA@n) Autowiz Options\r\n"
          "@gD@n) aDvancement Options\r\n"
          "@gT@n) Game Tick Options\r\n"
          "@gQ@n) Quit\r\n"
          "Enter your choice : "
          );
...
void cedit_disp_game_play_options(struct descriptor_data *d)
{
  ...
  write_to_output(d, "\r\n\r\n"
        "@gA@n) Player Killing Allowed  : @c%s\r\n"
        "@gB@n) Player Thieving Allowed : @c%s\r\n"
        "@gC@n) Minimum Level To Shout  : @c%d\r\n"
        "@gD@n) Holler Move Cost        : @c%d\r\n"
        "@gE@n) Tunnel Size             : @c%d\r\n"
        "@gF@n) Maximum Experience Gain : @c%d\r\n"
        "@gG@n) Maximum Experience Loss : @c%d\r\n"
        "@gH@n) Max Time for NPC Corpse : @c%d\r\n"
        "@gI@n) Max Time for PC Corpse  : @c%d\r\n"
        "@gJ@n) Tics before PC sent to void : @c%d\r\n"
        "@gK@n) Tics before PC is autosaved : @c%d\r\n"
        "@gL@n) Level Immune To IDLE        : @c%d\r\n"
        "@gM@n) Death Traps Junk Items      : @c%s\r\n"
        "@gN@n) Objects Load Into Inventory : @c%s\r\n"
        "@gO@n) Track Through Doors         : @c%s\r\n"
        "@gP@n) Display Closed Doors        : @c%s\r\n"
        "@gR@n) Unattainable Level          : @c%d\r\n"
        "@gS@n) Treat all Objects as Unique : @c%s\r\n"
        "@gT@n) Experience multiplier       : @c%.2f\r\n"
	"@g1@n) Stack Mobiles in room descs : @c%s\r\n"
	"@g2@n) Stack Objects in room descs : @c%s\r\n"
	"@g3@n) Allow mobs to fight mobs    : @c%s\r\n"
        "@g4@n) OK Message Text         : @c%s"
        "@g5@n) NOPERSON Message Text   : @c%s"
        "@g6@n) NOEFFECT Message Text   : @c%s"
        "@g7@n) Players can reroll stats on creation : @c%s\r\n"
	"@g8@n) Allow MCCP2 stream compression (recommended): @c%s\r\n"
	"@g9@n) Allow spoken languages : @c%s\r\n"
        "@gQ@n) Exit To The Main Menu\r\n"
        "Enter your choice : ",
...
void cedit_disp_crash_save_options(struct descriptor_data *d)
{
  ...
  write_to_output(d, "\r\n\r\n"
  	"@gA@n) Free Rent          : @c%s\r\n"
  	"@gB@n) Max Objects Saved  : @c%d\r\n"
  	"@gC@n) Minimum Rent Cost  : @c%d\r\n"
  	"@gD@n) Auto Save          : @c%s\r\n"
  	"@gE@n) Auto Save Time     : @c%d minute(s)\r\n"
  	"@gF@n) Crash File Timeout : @c%d day(s)\r\n"
  	"@gG@n) Rent File Timeout  : @c%d day(s)\r\n"
  	"@gQ@n) Exit To The Main Menu\r\n"
  	"Enter your choice : ",
...
void cedit_disp_room_numbers(struct descriptor_data *d)
{
  ...
  write_to_output(d, "\r\n\r\n"
  	"@gA@n) Mortal Start Room   : @c%d\r\n"
  	"@gB@n) Immortal Start Room : @c%d\r\n"
  	"@gC@n) Frozen Start Room   : @c%d\r\n"
  	"@g1@n) Donation Room #1    : @c%d\r\n"
  	"@g2@n) Donation Room #2    : @c%d\r\n"
  	"@g3@n) Donation Room #3    : @c%d\r\n"
  	"@gQ@n) Exit To The Main Menu\r\n"
  	"Enter your choice : ",
...
void cedit_disp_operation_options(struct descriptor_data *d)
{
  ...
  write_to_output(d, "\r\n\r\n"
  	"@gA@n) Default Port : @c%d\r\n"
  	"@gB@n) Default IP   : @c%s\r\n"
        "@gC@n) Default Directory   : @c%s\r\n"
        "@gD@n) Logfile Name        : @c%s\r\n"
        "@gE@n) Max Players         : @c%d\r\n"
        "@gF@n) Max Filesize        : @c%d\r\n"
        "@gG@n) Max Bad Pws         : @c%d\r\n"
        "@gH@n) Site Ok Everyone    : @c%s\r\n"
        "@gI@n) Name Server Is Slow : @c%s\r\n"
        "@gJ@n) Use new socials file: @c%s\r\n"
        "@gK@n) OLC autosave to disk: @c%s\r\n"
        "@gL@n) Main Menu           : \r\n@n%s@n\r\n"
        "@gM@n) Welcome Message     : \r\n@n%s@n\r\n"
        "@gN@n) Start Message       : \r\n@n%s@n\r\n"
    "@gQ@n) Exit To The Main Menu\r\n"
    "Enter your choice : ",
...
void cedit_disp_autowiz_options(struct descriptor_data *d)
{
  ...
  write_to_output(d, "\r\n\r\n"
    "@gA@n) Use the autowiz        : @c%s\r\n"
    "@gB@n) Minimum wizlist level  : @c%d\r\n"
    "@gQ@n) Exit To The Main Menu\r\n"
    "Enter your choice : ",
...
void cedit_disp_ticks_menu(struct descriptor_data *d)
{
  ...
  write_to_output(d, "\r\n\r\n"
      "@gA@n) Pulse Violence Time  : @c%d\r\n"
      "@gB@n) Mobile Action Time   : @c%d\r\n"
        "@gC@n) Zone Time            : @c%d\r\n"
        "@gD@n) Autosave Time        : @c%d\r\n"
        "@gE@n) Idle Password Time   : @c%d\r\n"
        "@gF@n) Sanity Check Time    : @c%d\r\n"
        "@gG@n) Usage Check Time     : @c%d\r\n"
        "@gH@n) Timesave Time        : @c%d\r\n"
        "@gI@n) Currents Update Time : @c%d\r\n"
        "@gQ@n) Exit To The Main Menu\r\n"
        "Enter your choice : ",
