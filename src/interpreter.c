...
cpp_extern const struct command_info cmd_info[] = {
  ...
  { "clsolc"   , "clsolc"	, POS_DEAD    , do_gen_tog  , 0, ADMLVL_IMMORT	, SCMD_CLS },
...
//  { "disarm"   , "dis"	, POS_STANDING, do_disarm   , 0, 0 },
  ...
  { "edit"     , "edit"		, POS_DEAD    , do_edit     , 0, ADMLVL_IMPL	, 0 },      /* Testing! */
  ...
  { "olc"      , "olc"		, POS_DEAD    , do_oasis    , 0, ADMLVL_BUILDER	, SCMD_OLC_SAVEINFO },
  ...
  { "rclone"   , "rclone"  	, POS_DEAD    , do_room_copy, 0, ADMLVL_BUILDER	, 0 },
  ...
  { "zreset"   , "zreset"	, POS_DEAD    , do_zreset   , 0, ADMLVL_GRGOD	, 0 },
...
void nanny(struct descriptor_data *d, char *arg)
{
  ...
  case CON_QROLLSTATS:
    ...
    mudlog(NRM, ADMLVL_IMMORT, TRUE, "%s [%s] new player.", GET_NAME(d->character), d->host);
    break;
